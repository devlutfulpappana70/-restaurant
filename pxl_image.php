...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_image',
        'title' => esc_html__('Case Image', 'savour' ),
        'icon' => 'eicon-image',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image',
                            'label' => esc_html__('Choose Image', 'savour' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image_width',
                            'label' => esc_html__('Image Width', 'savour' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'auto' => [
                                    'title' => esc_html__( 'Auto', 'savour' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Value', 'savour' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-parallax-scroll',
                            ],
                        ...
                        array(
                            'name' => 'max_tilt',
                            'label' => esc_html__('Max Tilt', 'savour' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                        ...
                        array(
                            'name' => 'speed_tilt',
                            'label' => esc_html__('Speed Tilt', 'savour' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            ...
                            'label' => esc_html__('Perspective Tilt', 'savour' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            ...
                            'label' => esc_html__('Disable Parallax on Mobile <= 767px', 'savour'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'false',
                            'condition' => [
                                'img_effect' => ['pxl-parallax-scroll'],
