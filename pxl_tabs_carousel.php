...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Tabs Carousel', 'savour'),
        'icon' => 'eicon-tabs',
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-tabs-carousel .pxl-item--title' => 'color: {{VALUE}};text-fill-color: {{VALUE}};-webkit-text-fill-color: {{VALUE}};background-image: none;',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-tabs-carousel .pxl-item--title',
                        ),
                    ),
                ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'autoplay_speed',
                            'label' => esc_html__('Autoplay Speed', 'savour'),
                        ...
                        array(
                            'name' => 'thumb_col_xs',
                            'label' => esc_html__('Tab Columns XS Devices', 'savour' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '1',
                            'options' => [
                                'auto' => 'Auto',
                        ...
                        array(
                            'name' => 'thumb_col_sm',
                            'label' => esc_html__('Tab Columns SM Devices', 'savour' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '2',
                            'options' => [
                                'auto' => 'Auto',
                        ...
                        array(
                            'name' => 'thumb_col_md',
                            'label' => esc_html__('Tab Columns MD Devices', 'savour' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '3',
                            'options' => [
                                'auto' => 'Auto',
                        ...
                        array(
                            'name' => 'thumb_col_lg',
                            'label' => esc_html__('Tab Columns LG Devices', 'savour' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '3',
                            'options' => [
                                'auto' => 'Auto',
