...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-post-carousel pxl-post-carousel2 pxl-blog-style2" <?php if($settings['drap'] !== 'false') : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'savour'); ?>"<?php endif; ?>>
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php
                        $image_size = !empty($img_size) ? $img_size : '765x400';
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner <?php echo esc_attr($pxl_animate); ?>">
                                <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): 
                                    ...
                                    <div class="pxl-item--featured">
                                        ...
                                        <?php if($show_category == 'true'): ?>
                                            <div class="pxl-item--category pxl-l-32">
                                ...
                                <?php endif; ?>
                                <div class="pxl-item--holder pxl-pr-30">
                                    ...
                                    <?php if($show_button == 'true') : ?>
                                        <div class="pxl-item--button">
                                            <a class="btn-text-divider1" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                                <span><?php if(!empty($button_text)) {
                                                    echo esc_attr($button_text);
                                                } else {
                                                    echo esc_html__('Read more', 'savour');
                                                } ?></span>
                                                <i class="flaticon-right-arrow3 pxl-ml-11"></i>
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
