...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Team Carousel', 'savour'),
        ...
        'params' => array(
            'sections' => array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'icon_label',
                                    'label' => esc_html__('Icon Label', 'savour'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'icon_link',
                                    'label' => esc_html__('Icon Link', 'savour'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                ),
                            ),
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel Settings', 'savour'),
