<?php 
/* Start Section */
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_controls' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_overlay_color' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_overlay_img' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_divider' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_particles' );
add_action( 'elementor/element/section/section_structure/after_section_end', 'savour_add_custom_section_effect_image' );
function savour_add_custom_section_controls( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__( 'Savour General Settings', 'savour' ),
    ...
    if ( get_post_type( get_the_ID()) === 'pxl-template' && get_post_meta( get_the_ID(), 'template_type', true ) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__( 'Header Type', 'savour' ),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__( 'Select Type', 'savour' ),
                    'sticky'      => esc_html__( 'Header Sticky', 'savour' ),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__( 'Column Fixed', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'savour' ),
                'fixed'   => esc_html__( 'Yes', 'savour' ),
            ),
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Overflow', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__( 'Visible', 'savour' ),
                'hidden'   => esc_html__( 'Hidden', 'savour' ),
            ),
            'default'      => 'visible', 
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__( 'Parallax Background Image', 'savour' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position', 'savour' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'X Position', 'savour' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Y Position', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Size', 'savour' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'savour' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Width', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Position', 'savour' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'savour' ),
            'label_on' => esc_html__( 'Custom', 'savour' ),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ] 
    ...
    $element->start_popover();
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left', 'savour' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top', 'savour' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Right', 'savour' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom', 'savour' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Effect', 'savour' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'savour' ),
            'label_on' => esc_html__( 'Custom', 'savour' ),
            'return_value' => 'yes',
    ...
    $element->start_popover();
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateX', 'savour' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateY', 'savour' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateZ', 'savour' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'savour' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'savour' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'savour' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'savour' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'savour' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Z', 'savour' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale', 'savour' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scroll From (px)', 'savour' ).' (350) from offset top',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__( 'Parallax Opacity (0 - 100)', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ '%' ],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
          'label' => esc_html__( 'Full Content with space from?', 'savour' ),
          'type'         => \Elementor\Controls_Manager::SELECT,
                'prefix_class' => 'pxl-full-content-with-space-',
                'options'      => array(
                    'none'    => esc_html__( 'None', 'savour' ),
                    'start'   => esc_html__( 'Start', 'savour' ),
                    'end'     => esc_html__( 'End', 'savour' ),
                ),
                'default'      => 'none',
                'condition' => [
                    'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
                'label' => esc_html__('Container Width', 'savour'),
...
function savour_add_custom_section_overlay_color( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_color',
        [
            'label' => esc_html__( 'Savour Overlay Color', 'savour' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_color_offset',
        [
            'label'   => esc_html__( 'Overlay Color', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'savour' ),
                'left'   => esc_html__( 'Left Space', 'savour' ),
                'right'   => esc_html__( 'Right Space', 'savour' ),
                'skew'   => esc_html__( 'Skew', 'savour' ),
            ),
    ...
    $element->add_control(
        'overlay_left_space',
        [
            'label' => esc_html__('Overlay Left Space', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
    ...
    $element->add_control(
        'overlay_right_space',
        [
            'label' => esc_html__('Overlay Right Space', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overlay Border Radius', 'savour' ),
...
function savour_add_custom_section_overlay_img( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_img',
        [
            'label' => esc_html__( 'Savour Overlay Image', 'savour' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_overlay_display',
        [
            'label'   => esc_html__( 'Overlay Image', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'savour' ),
                'image'   => esc_html__( 'Yes', 'savour' ),
            ),
    ...
    $element->add_control(
        'pxl_overlay_img',
        [
            'label'   => esc_html__( 'Select Image 1', 'savour' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 1', 'savour' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'savour' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 1', 'savour' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 1', 'savour' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 1', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_control(
        'pxl_overlay_img2',
        [
            'label'   => esc_html__( 'Select Image 2', 'savour' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
                'pxl_overlay_display' => ['image'],
            ],
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 2', 'savour' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'savour' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 2', 'savour' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 2', 'savour' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 2', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Offset Left - Image 2', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function savour_add_custom_section_divider( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_divider',
        [
            'label' => esc_html__( 'Savour Divider', 'savour' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            ...
            'options' => array(
                ...
                'rounded-top'   => esc_html__( 'Rounded Top', 'savour' ),
                'angle-top'   => esc_html__( 'Angle Top Left', 'savour' ),
                'angle-top-right'   => esc_html__( 'Angle Top Right', 'savour' ),
                'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'savour' ),
                'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'savour' ),
                'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'savour' ),
                'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'savour' ),
                'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'savour' ),
                'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'savour' ),
                'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'savour' ),
                'curved-top'   => esc_html__( 'Curved Top', 'savour' ),
                'curved-bottom'   => esc_html__( 'Curved Bottom', 'savour' ),
                'vertical1'   => esc_html__( 'Divider Vertical', 'savour' ),
                'curved-arrow'   => esc_html__( 'Curved Arrow', 'savour' ),
                'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'savour' ),
                'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'savour' ),
                'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'savour' ),
            ),
    ...
    $element->add_responsive_control(
        'divider_height',
        [
            'label' => esc_html__('Divider Height', 'savour' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function savour_add_custom_section_particles( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_particles',
        [
            'label' => esc_html__( 'Savour Particles', 'savour' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Particles', 'savour' ),
    ...
    $element->add_control(
        'size_random',
        [
                'label' => esc_html__('Size Random', 'savour'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'false',
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'move_direction',
        [
            'label'   => esc_html__( 'Move Direction', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'savour' ),
                ...
                'bottom-right'        => esc_html__( 'Bottom Right', 'savour' ),
                'bottom'        => esc_html__( 'Bottom', 'savour' ),
                'bottom-left'        => esc_html__( 'Bottom Left', 'savour' ),
                'left'        => esc_html__( 'Left', 'savour' ),
                'top-left'        => esc_html__( 'Top Left', 'savour' ),
            ),
            'default'      => 'none',
            'condition' => [
...
function savour_add_custom_section_effect_image( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_effect_image',
        [
            'label' => esc_html__( 'Savour Effect Images', 'savour' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $repeater_img->add_control(
        'effect_image', 
        [
            'label' => esc_html__('Image Effect', 'savour' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                '' => 'None',
                'pxl-image-spin' => 'Spin',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Type', 'savour' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'y' => 'Effect Y',
                'x' => 'Effect X',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Value', 'savour' ),
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Hover Value', 'savour' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '40',
            'description' => esc_html__('Enter number.', 'savour' ),
            'condition' => [
    ...
    $repeater_img->add_control(
        'image_display', 
        [
            'label' => esc_html__('Hide on Screen <= 1400px', 'savour'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_md', 
        [
            'label' => esc_html__('Hide on Screen <= 1200px', 'savour'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_sm', 
        [
            'label' => esc_html__('Hide on Screen <= 767px', 'savour'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
...
/* Start Column */
add_action( 'elementor/element/column/layout/after_section_end', 'savour_add_custom_columns_controls' ); 
function savour_add_custom_columns_controls( \Elementor\Element_Base $element) {
    $element->start_controls_section(
        'columns_pxl',
        [
            'label' => esc_html__( 'Savour General Settings', 'savour' ),
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__( 'Column Content Align', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__( 'Default', 'savour' ),
                'start'           => esc_html__( 'Start', 'savour' ),
                'center'           => esc_html__( 'Center', 'savour' ),
                'end'           => esc_html__( 'End', 'savour' ),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__( 'Column Sticky', 'savour' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__( 'No', 'savour' ),
                'sticky' => esc_html__( 'Yes', 'savour' ),
            ),
            'default' => 'none',
...
add_action( 'elementor/element/after_add_attributes', 'savour_custom_el_attributes', 10, 1 );
function savour_custom_el_attributes($el){
...
add_filter( 'pxl-custom-section/before-render', 'savour_custom_section_before_render', 10, 3 );
function savour_custom_section_before_render($html ,$settings, $el) {
