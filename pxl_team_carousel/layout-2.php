...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): 
    $image_size = !empty($settings['img_size']) ? $settings['img_size'] : '243x243'; ?>
    <div class="pxl-swiper-sliders pxl-team pxl-team-carousel2 pxl-team-layout2 pxl-swiper-boxshadow" <?php if($drap !== 'false') : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'savour'); ?>"<?php endif; ?>>
                            ...
                            <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                ...
                                <div class="pxl-item--bottom">
                                    <?php if(!empty($email_address)) : ?>
                                        <div class="pxl-item--email"><i class="flaticon-email"></i><a href="<?php echo esc_attr($email_link); ?>"><?php echo esc_attr($email_address); ?></a></div>
                                    <?php endif;  ?>
                                    <?php if(!empty($phone_number)) : ?>
                                        <div class="pxl-item--phone"><i class="flaticon-telephone-solid"></i><a href="<?php echo esc_attr($phone_link); ?>"><?php echo esc_attr($phone_number); ?></a></div>
                                    <?php endif;  ?>
                                </div>
                           </div>
                        </div>
