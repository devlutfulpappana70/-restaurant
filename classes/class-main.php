...
if (!class_exists('Savour_Main')) { 
    class Savour_Main extends Savour_Base
    {
...
function savour() {
    return Savour_Main::getInstance();
}
// Install
savour(); 
