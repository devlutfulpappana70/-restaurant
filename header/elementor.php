<?php 
$logo_m = savour()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = savour()->get_page_opt('p_menu');
$p_menu_mobile = savour()->get_page_opt('p_menu_mobile');
$header_mobile = savour()->get_page_opt('header_mobile', 'show');
$sticky_scroll = savour()->get_opt('sticky_scroll');
...
$mobile_style = savour()->get_opt('mobile_style');
$mobile_display = savour()->get_opt('mobile_display');
$header_mobile_layout = savour()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)savour()->get_opt('header_mobile_layout');
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php savour_header_mobile_search_form(); ?>
                                <nav class="pxl-header-nav">
                                    <?php 
                                        if ( has_nav_menu( 'primary' ) )
                                        {
                                            ...
                                            if(isset($p_menu_mobile) && !empty($p_menu_mobile)) {
                                                $attr_menu['menu'] = $p_menu_mobile;
                                            }
