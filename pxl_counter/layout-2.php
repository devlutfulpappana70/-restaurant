...
<div class="pxl-counter pxl-counter2 bg-image <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl--item-inner">
        <?php if ( $settings['icon_type'] == 'icon' && !empty($settings['pxl_icon']['value']) ) : ?>
            <div class="pxl-item--icon <?php if($settings['icon_color_type'] == 'gradient') { echo 'pxl-color--gradient'; } ?>">
        ...
        <div class="pxl--counter-meta">
            <div class="pxl--counter-number <?php if($settings['number_color_type'] == 'gradient') { echo 'text-gradient'; } ?>">
            ...
            <?php if(!empty($settings['title'])) : ?>
                <h3 class="pxl--item-title"><?php echo pxl_print_html($settings['title']); ?></h3>
            <?php endif; ?>
        </div>
    </div>
</div>